...
class UserDataManager:
    """Unified manager for user data storage and operations"""
    ...
    def get_user(self, username):
        """Get a specific user's data by username (case-insensitive)"""
    ...
    def save_current_user(self):
        ...
        all_user_data = self.load_user_data()
        ...
        # Save all user data
        self.save_user_data(all_user_data)
