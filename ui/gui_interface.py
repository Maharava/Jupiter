...
class GUIInterface:
    ...
    def _run_gui(self):
        ...
        self.knowledge_view = KnowledgeView(
            self.root,
            jupiter_color=self.jupiter_color,
            clean_callback=self.show_chat_view
        )
    ...
    def _setup_calendar_button(self, button_frame):
        """Set up calendar button if calendar module is available"""
        try:
    ...
    def show_knowledge_view(self):
        ...
        try:
            ...
            print(f"Error showing knowledge view: {e}")
    ...
    def show_chat_view(self):
        ...
        try:
            ...
            print(f"Error showing chat view: {e}")
    ...
    def create_knowledge_bubbles(self, user_data):
        ...
        self.knowledge_view.create_knowledge_bubbles(user_data)
    ...
    def process_knowledge_edits(self):
        ...
        try:
            ...
            print(f"Error processing knowledge edits: {e}")
